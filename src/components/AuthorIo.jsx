    ...
    <>
      <Link className="homeLink" to={"/"}>
        ...
        >
          <g>
            <svg
              viewBox="0 0 523.4819084980114 74.21920440000001"
              height="56.0767798232315"
              width="395.52"
            >
              <g>
                <rect
                  width="6.289740491862857"
              ...
              <g transform="matrix(1,0,0,1,0,2.236745057142862)">
                <svg
                  viewBox="0 0 395.52 69.74571428571429"
                  height="69.74571428571429"
                  width="395.52"
                >
              ...
              <g transform="matrix(1,0,0,1,449.26270409801145,0)">
                <svg
                  viewBox="0 0 74.21920440000001 74.21920440000001"
                ...
                >
                  <g>
                    <svg
                      ...
                      id="icon-0"
                    >
                      <g fill="#1b2141" data-fill-palette-color="accent">
                        <g fill="#1b2141" data-fill-palette-color="accent">
                          <path
                            d="M53.5 7.5h-43c-1.654 0-3 1.346-3 3v43c0 1.654 1.346 3 3 3h43c1.654 0 3-1.346 3-3v-43C56.5 8.846 55.154 7.5 53.5 7.5zM55.5 53.5c0 1.103-0.897 2-2 2h-43c-1.103 0-2-0.897-2-2v-43c0-1.103 0.897-2 2-2h43c1.103 0 2 0.897 2 2V53.5z"
                            fill="#1b2141"
                            data-fill-palette-color="accent"
                          ></path>
                          <path
                            d="M48 19.5H16c-0.276 0-0.5 0.224-0.5 0.5s0.224 0.5 0.5 0.5h32c0.276 0 0.5-0.224 0.5-0.5S48.276 19.5 48 19.5z"
                            fill="#1b2141"
                            data-fill-palette-color="accent"
                          ></path>
                          <path
                            d="M48 31.5H16c-0.276 0-0.5 0.224-0.5 0.5s0.224 0.5 0.5 0.5h32c0.276 0 0.5-0.224 0.5-0.5S48.276 31.5 48 31.5z"
                            fill="#1b2141"
                            data-fill-palette-color="accent"
                          ></path>
                          <path
                            d="M48 43.5H16c-0.276 0-0.5 0.224-0.5 0.5s0.224 0.5 0.5 0.5h32c0.276 0 0.5-0.224 0.5-0.5S48.276 43.5 48 43.5z"
                            fill="#1b2141"
                            data-fill-palette-color="accent"
                          ></path>
                        </g>
